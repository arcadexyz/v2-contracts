...
import "./interfaces/IFlashRolloverNewLender.sol";
 ...
 *
 */
contract FlashRolloverNewLender is IFlashRolloverNewLender, ReentrancyGuard, ERC721Holder, ERC1155Holder {
    ...
    function rolloverLoan(
...

        {
            ...
            bytes memory params = abi.encode(
                OperationData({ contracts: contracts, loanId: loanId, newLoanTerms: newLoanTerms, newLender: newLender, v: v, r: r, s: s })
            );
    ...
    function _executeOperation(
        ...
        address lender = opData.newLender;
