...
describe("Rollovers", () => {
    ...
    describe("Rollover Loan",  () => {
        ...
        it("should roll over a loan with extra principal for the borrower and the same lender", async () => {
            ...
            // Borrower get principal difference - interest - rollover fee
            expect(borrowerBalanceAfter.sub(borrowerBalanceBefore)).to.eq(ethers.utils.parseUnits("89.9"));
        ...
        it("should roll over a loan with extra principal for the borrower and a different lender");
